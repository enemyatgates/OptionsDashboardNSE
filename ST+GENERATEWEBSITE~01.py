...
<div class="tabbar" id="tabbar">
  ...
  <button class="tab-btn" data-tab="participant">
    <span class="tab-icon">⊞</span> Participant OI &amp; TV
  </button>
  <button class="tab-btn" data-tab="pcr">
  ...
  <button class="tab-btn" data-tab="maxpain">
    <span class="tab-icon">⊗</span> Max Pain
  </button>
  <button class="tab-btn" data-tab="ivskew">
...
<main class="main" id="main">
  ...
  <div class="tab-panel" id="tab-pcr">
    <div class="placeholder">
      ...
      <div class="placeholder-title">PCR Analysis</div>
      <div class="placeholder-sub">
        Participant-level PCR trends (OI + volume), aggregate chain PCR, net PCR and short-side PCR.
        Charts built in Step 6.
      </div>
      <span class="placeholder-tag">Step 6</span>
    </div>
  </div>
  ...
  <div class="tab-panel" id="tab-bias">
    <div class="placeholder">
      <div class="placeholder-icon">⊿</div>
      <div class="placeholder-title">Net Bias &amp; Efficiency</div>
      <div class="placeholder-sub">
        Net OI trends, OI-TV efficiency ratio, net conviction cross-check per participant.
        Charts built in Step 7.
      </div>
      <span class="placeholder-tag">Step 7</span>
    </div>
  </div>
  ...
  <div class="tab-panel" id="tab-chain">
    <div class="placeholder">
      <div class="placeholder-icon">≡</div>
      <div class="placeholder-title">Option Chain</div>
      <div class="placeholder-sub">
        Strike table (ATM ±20, expandable), OI bar chart per strike, per-strike PCR.
        Built in Step 8.
      </div>
      <span class="placeholder-tag">Step 8</span>
    </div>
  </div>
  ...
  <div class="tab-panel" id="tab-maxpain">
    <div class="placeholder">
      <div class="placeholder-icon">⊗</div>
      <div class="placeholder-title">Max Pain</div>
      <div class="placeholder-sub">
        Per-strike pain heatmap, max pain trend across sessions.
        Built in Step 9.
      </div>
      <span class="placeholder-tag">Step 9</span>
    </div>
  </div>
  ...
  <div class="tab-panel" id="tab-ivskew">
    <div class="placeholder">
      <div class="placeholder-icon">∿</div>
      <div class="placeholder-title">IV Skew</div>
      <div class="placeholder-sub">
        Call vs Put IV curve across strikes, put-call skew differential.
        Built in Step 10.
      </div>
      <span class="placeholder-tag">Step 10</span>
    </div>
  </div>
  ...
  <div class="tab-panel" id="tab-history">
    <div class="placeholder">
      <div class="placeholder-icon">⏱</div>
      <div class="placeholder-title">Historical Trends</div>
      <div class="placeholder-sub">
        All metrics trended across every session in the data folder —
        FII net futures OI, PCR, max pain, participant market share.
        Built in Step 11.
      </div>
      <span class="placeholder-tag">Step 11</span>
    </div>
  </div>
